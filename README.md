...
To fully explore the interactive dashboard, please download the [**SalesAnalysisPBI.pbix**](powerbi/SalesAnalysisPBI.pbix) file located in the **powerbi/** folder and open it in Power BI Desktop.
