...
To fully explore the interactive dashboard, please [download the **SalesAnalysisPBI.pbix** file](powerbi/SalesAnalysisPBI.pbix) located in the **powerbi/** folder and open it in Power BI Desktop.
