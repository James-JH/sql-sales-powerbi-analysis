...
To fully explore the interactive dashboard, please download the [Download the Power BI file](powerbi/SalesAnalysisPBI.pbix) _**SalesAnalysisPBI.pbix**_ file located in the **powerbi/** folder and open it in Power BI Desktop.
