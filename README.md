...
To fully explore the interactive dashboard, please download the _**SalesAnalysisPBI.pbix**_ file located in the **powerbi/** folder and open it in Power BI Desktop.
