...
To fully explore the interactive dashboard, please [download the_**SalesAnalysisPBI.pbix**_ file](powerbi/SalesAnalysisPBI.pbix) located in the **powerbi/** folder and open it in Power BI Desktop.
